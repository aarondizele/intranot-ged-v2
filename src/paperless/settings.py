...
SPECTACULAR_SETTINGS = {
    "TITLE": "Intranot GED REST API",
    "DESCRIPTION": "OpenAPI Spec for Intranot GED",
    "VERSION": "6.0.0",
    "SERVE_INCLUDE_SCHEMA": False,
    "SWAGGER_UI_DIST": "SIDECAR",
    "COMPONENT_SPLIT_REQUEST": True,
    "EXTERNAL_DOCS": {
        "description": "Intranot GED API Documentation",
...
EMAIL_SUBJECT_PREFIX: Final[str] = "[Intranot GED] "
EMAIL_TIMEOUT = 30.0
...
MFA_TOTP_ISSUER = "Intranot GED"

ACCOUNT_EMAIL_SUBJECT_PREFIX = "[Intranot GED] "
