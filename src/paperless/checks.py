...
def check_postgres_version(app_configs, **kwargs):
    ...
    a future Intranot GED version. This check can be removed eventually.
        ...
        try:
            with db_conn.cursor() as cursor:
                ...
                if version.startswith("13"):
                    return [
                        Warning(
                            "PostgreSQL 13 is deprecated and will not be supported in a future Intranot GED release.",
